...
import com.ragnews.search.config.LocalEnvironmentResolver;
...
public class OpenAiEmbeddingGenerator implements EmbeddingGenerator {
    ...
    public List<Double> generateEmbedding(String text) {
        if (text == null || text.isBlank()) {
            throw new IllegalArgumentException("Search query text cannot be blank");
        }

        return createEmbedding(text.trim());
    }
